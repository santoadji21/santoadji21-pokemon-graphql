...
export default function Footer() {
  return (
    <footer id="page-footer">
      <div className="text-center text-sm lg:text-base container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-24">
        <div className="space-y-10">
          <nav className="space-x-4">
            <Link href="https://www.instagram.com/santoadji21/" passHref>
              <a
            ...
            <Link href="https://github.com/santoadji21" passHref>
              <a
                className="text-cyan-600 hover:text-cyan-400"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <Link href="https://dribbble.com/Alkahfistudio" passHref>
              <a
                className="text-cyan-600 hover:text-cyan-400"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className="icon-dribble inline-block w-5 h-5"
                >
        ...
        <div>
          <span className="font-medium">santoadji21</span> ©2022
        </div>
      </div>
    </footer>
  );
